...
import com.example.springbootjwttest.dto.UserDataDto;
import com.example.springbootjwttest.dto.UserResponseDto;
...
public class UserController {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 400, message = "Client's bad request"),
			@ApiResponse(code = 422, message = "Invalid username/password")
			})
	public String login(
			@ApiParam @RequestParam String username,
